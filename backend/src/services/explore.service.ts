    ...
    const defaultPlants = [
      {
        ...
        light: 'Low to Bright',
        water: 'Low',
        tags: ['Low Maintenance', 'Pet Safe', 'Air Purifying'],
        description: 'Extremely low maintenance, perfect for beginners. Thrives in low light.',
        icon: 'grass_rounded',
      },
      {
        name: 'Pothos',
        ...
        light: 'Low to Bright',
        water: 'Medium',
        tags: ['Low Maintenance', 'Trailing', 'Fast Growing'],
        description: 'Fast-growing vine perfect for hanging baskets. Very forgiving.',
        icon: 'park_rounded',
      },
      {
        name: 'Monstera',
      ...
      },
      {
        ...
        light: 'Low to Bright',
        water: 'Very Low',
        tags: ['Low Maintenance', 'Drought Tolerant', 'Pet Safe'],
      ...
      },
      {
        ...
        light: 'Bright Indirect',
        water: 'Medium',
        tags: ['Pet Safe', 'Air Purifying', 'Propagates Easily'],
        description: 'Produces baby plants. Great for beginners and pets.',
      ...
      },
      {
        ...
        light: 'Bright Indirect',
        water: 'Medium',
        tags: ['Low Maintenance', 'Air Purifying', 'Glossy Leaves'],
        description: 'Large, glossy leaves. Easy to care for and grows tall.',
        icon: 'nature_rounded',
      },
      {
        name: 'Aloe Vera',
        ...
        description: 'Medicinal properties. Thrives on neglect and bright light.',
      ...
      },
      {
        ...
        light: 'Bright',
        water: 'Low',
        tags: ['Succulent', 'Low Maintenance', 'Symbolic'],
        description: 'Symbol of good luck. Very drought tolerant succulent.',
